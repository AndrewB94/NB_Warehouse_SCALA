 ...
 * @date 06/11/2015
 */
class CustomerOrder(customerOrderStatus_ :String, datePlaced_ :Date, customer_ :String, employee_ :Int, isPaid_ :Boolean, addressId_ :Int, serialVersionUID:Long, idCustomerOrder_ :Int, dateShipped:Date) {
